...
// Routes
router.get("/", getDiningTables);
router.post("/add", addDiningTable);
router.post("/delete/:id", deleteDiningTable);
router.post("/reserve/:id", reserveTable);
// router.post("/vacate/:id", vacateTable);
// router.post("/update-status/:id", updateTableStatus);
